        ...
        <div className={styles.introBox3}>
            ...
            <div className={styles.introBox3Content}>
                ...
                >
                    ...
                    <h4>
                        <b>Frontend Engineer</b> at <b>Pagoda Labs.</b>
                    </h4>
                    <p>
                        You’re just browsing a website…
                        And suddenly—POOF—an ad jumps you like a wild Ninja.
                        {" "}
                        <br></br>  Hi. It’s me.
                    </p>
                </AnimatorOnScroll>
                ...
                <AnimatedTags
                    tags={["React", "TypeScript", "Material UI", "JavaScript"]}
                    delay={0.8}
                />
            </div>
        </div>
